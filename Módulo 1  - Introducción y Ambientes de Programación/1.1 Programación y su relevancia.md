...
Este documento da inicio al Módulo 1. Si está leyendo esto, ha comenzado su introducción al mundo de la programación. Este curso está diseñado para descubrir el potencial de la programación con Python, independientemente de su campo de estudio o profesión (arte, humanistica, sociales, ingeniería, medicina, etc). No se requieren conocimientos previos de programación, solo una disposición para aprender.
